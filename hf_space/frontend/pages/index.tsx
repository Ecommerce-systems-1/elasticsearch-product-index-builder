...
const TITLE = "Product Index Builder";
const TAGLINE = "A from-scratch inverted index over 500 products: BM25-style scoring, field boosts, filters, and facets.";
...
const ENDPOINTS: Endpoint[] = [
  ...
  {
    "label": "Search 'cozy sweater'",
    "method": "GET",
    "path": "/search?q=cozy+sweater"
  },
  {
    "label": "Search with price filter",
    "method": "GET",
    "path": "/search?q=jacket&min_price=100&max_price=200"
  },
  {
    "label": "Facets for 'warm'",
    "method": "GET",
    "path": "/facets?q=warm"
  },
  {
